...
import common_gauss as common
import material_utils_gauss as material_utils
from diff_render_module import DiffRenderModule


@dataclasses.dataclass
class GaussMaterialsExample:
    width: int = 1920
    height: int = 1080
    ...
    ref_scene_filepath: str = (
        "inv_rendering_scenes/testCustom_ref.pyscene"
    )

    init_scene_filepath: str = (
        "inv_rendering_scenes/testCustom_init.pyscene"
    )
    ...
    def __post_init__(self):
        ...
        self.passes["gauss_diff_pt"].scene_gradients = scene_gradients
